...
-(NSString *)stringFromChannelUserList:(NSNumber *)key
{
    ...
    else if(listArray.count > 2)
    {
        ...
        str = [NSString stringWithFormat:@"+%d %@",counter, NSLocalizedStringWithDefaultValue(@"moreMember", [ALApplozicSettings getLocalizableName], [NSBundle mainBundle], NSLocalizedString(@"more", nil), @"")];
