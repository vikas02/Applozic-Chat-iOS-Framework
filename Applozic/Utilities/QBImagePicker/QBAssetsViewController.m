...
- (IBAction)done:(id)sender
{
    ...
    NSLog(@"Sonal =  %@",self.imagePickerController.selectedAssets.array);
    ...
    [self processImagesForChatSDK];
}


-(void)processImagesForChatSDK
{
    ...
    if ([self.imagePickerController.delegate respondsToSelector:@selector(multipleAttachmentProcessQB:attachmentPathArray:andText:)]) {
        [self.imagePickerController.delegate multipleAttachmentProcessQB:self.imagePickerController attachmentPathArray:self.mediaFileArray andText:nil];
    }
}
